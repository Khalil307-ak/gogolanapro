const translations = {
    ...
    "ar": {
        ...
        "installation-desc": "للبدء، قم بتحميل أحدث نسخة من بايثون من موقع بايثون الرسمي. اتبع الخطوات التالية:",
        "install-windows": "لنظام ويندوز: قم بتنزيل المثبت وتأكد من تحديد خيار \"إضافة بايثون إلى PATH\".",
        "install-mac": "لنظام macOS: استخدم Homebrew (brew install python) أو المثبت من الموقع الرسمي.",
        "install-linux": "لنظام لينكس: استخدم الأمر sudo apt install python3 (لأوبونتو) أو مدير الحزم الخاص بنظامك.",
        "verify-install": "تحقق من التثبيت باستخدام الأمر: python3 --version أو python --version.",
        "first-steps": "خطوات البداية الأولى",
        "first-steps-desc": "ابدأ بكتابة برامج بسيطة لفهم بناء الجملة في بايثون:",
        "run-code": "احفظ الكود في ملف hello.py وشغله باستخدام الأمر python3 hello.py.",
        ...
        "resource-docs": "الوثائق الرسمية لبايثون",
        "resource-codecademy": "Codecademy - تعلم بايثون",
        "resource-coursera": "Coursera - دورات بايثون",
        "resource-realpython": "Real Python - دروس متقدمة",
    ...
    "en": {
        ...
        "why-python-desc": "Python is distinguished by its simple syntax, making it ideal for beginners. It also has powerful libraries like pandas, numpy, and tensorflow used in advanced fields. Python is the top choice for many companies like Google and Netflix.",
        "installation": "Python Installation",
        "installation-desc": "To get started, download the latest version of Python from the official Python website. Follow these steps:",
        "install-windows": "For Windows: Download the installer and make sure to check the option \"Add Python to PATH\".",
        "install-mac": "For macOS: Use Homebrew (brew install python) or the official installer.",
        "install-linux": "For Linux: Use the command sudo apt install python3 (for Ubuntu) or your system's package manager.",
        "verify-install": "Verify the installation using the command: python3 --version or python --version.",
        "first-steps": "First Steps",
        "first-steps-desc": "Start by writing simple programs to understand Python's syntax:",
        "run-code": "Save the code in a file named hello.py and run it using the command python3 hello.py.",
        ...
        "loops": "Loops:",
        "functions": "Functions",
        "functions-desc": "Functions allow code reusability. Example:",
        "lists": "Lists",
        ...
        "project-calculator-desc": "Write a program that asks the user to input two numbers and a mathematical operation:",
        "project-game": "Number Guessing Game",
        "project-game-desc": "A program that chooses a random number and asks the user to guess it:",
        "resources": "Learning Resources",
        "resources-desc": "Explore these resources to learn more:",
        "resource-docs": "Official Python Documentation",
        "resource-codecademy": "Codecademy - Learn Python",
        "resource-coursera": "Coursera - Python Courses",
        "resource-realpython": "Real Python - Advanced Tutorials",
